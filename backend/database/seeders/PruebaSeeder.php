...
class PruebaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $pregunta = [
            ...
            [
                'question' => '
                    Te encuentras una habitación con un piano y una nota que dice: "En la musica la clave está y mientras en una CAGE te encontraras"
                ',
                'answer' => 'Do, La, Sol, Mi',
                'clue' => '
                    Nomenclatura latina: Do Re Mi Fa Sol La Si Do, Cifrado americano: C D E F G A B C
                ',
            ...
            [
                'question' => '
                    Encuentras una nota que dice: Te lo diré de una foma que puedas recordar, mira a tu alrededor y recuerda: Enfermeras, Médicos y Arboles. Ves 3 cuadros, uno donde aprarecen 2 Médicos, otro donde aparecen 9 enfermeras 2 de ellos apartadas del resto y finalmente otro de la entrada de un hospital con 4 arboles.
                ',
                'answer' => '724',
